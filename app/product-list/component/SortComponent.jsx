      ...
      {loading ? (
        ...
        <>
          ...
          <div className="relative w-full">
            ...
            />
            <button className="absolute p-2 text-white transform -translate-y-1/2 bg-teal-600 rounded-full shadow top-1/2 right-3 hover:bg-[#e58110] focus:outline-none focus:ring-2 focus:ring-[#e58110]">
...
const SkeletonLoader = () => {
  return (
    <div className="flex w-full gap-10 animate-pulse">
      {/* Search Bar Skeleton */}
